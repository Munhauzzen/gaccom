$(function () {
  ...
  $('.gac-mistakes-form__btn').on('click', function () {
    $('.gac-mistakes__block1').addClass('gac-thank--dis');
    $('.gac-mistakes__block2').addClass('gac-thank--act');
  });

  $('.gac-cost__tabs .gac-tab').on('click', function (event) {
    var id = $(this).attr('data-id');
    $('.gac-cost__tabs').find('.gac-tab-item').removeClass('gac-active-tab').hide();
    $('.gac-active[tab-content]').removeClass('gac-active').hide();
    $('.gac-cost__tabs .gac-tabs').find('.gac-tab').removeClass('gac-active');
    $(this).addClass('gac-active');
...
jQuery(document).ready(function ($) {
  ...
  $('#gac-proof-form').on('submit', function (e) {
    ...
    if (!$('#proof-email').hasClass('gac-invalid')) {
